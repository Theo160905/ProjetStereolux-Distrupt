...
public void DragLeftPageToPoint(Vector3 point)
{
    ...
    Right.transform.SetAsFirstSibling();
    Right.sprite = (currentPage - 1 >= 0 && currentPage - 1 < bookPages.Length)
    ...
    Left.sprite = (currentPage - 2 >= 0 && currentPage - 2 < bookPages.Length)
        ? bookPages[currentPage - 2]
        : background;

    LeftNext.sprite = (currentPage - 3 >= 0 && currentPage - 3 < bookPages.Length)
